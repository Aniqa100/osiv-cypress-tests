...
describe('First test', () => {
    ...
    it('create protocol and remove it', () => {
      ...
      cy.get('[class="akUserInfo"]').should('contain', 'Hulk1');
      ...
      cy.wait(4000);
      cy.get('#cke_187_contents > .cke_wysiwyg_div').type('test');
      //cy.get('[id="cke_87_contents"]').find('[class="cke_wysiwyg_div"]').type('test');
